      ...
      <div className="relative z-10 w-full max-w-7xl px-6 flex flex-col items-center">
        ...
        <div className="relative mb-20">
          ...
          >
            ...
            <h3 className="font-headline text-lg font-bold text-primary tracking-widest">ARCHITECTURE</h3>
          ...
          >
            ...
            <h3 className="font-headline text-lg font-bold text-secondary tracking-widest">PROJECTS</h3>
          </motion.div>
          ...
          >
            ...
            <h3 className="font-headline text-lg font-bold text-primary-container tracking-widest">CLOUD</h3>
          </motion.div>
        ...
        <div className="text-center z-20 space-y-6">
          ...
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="font-headline text-6xl md:text-8xl font-extrabold tracking-tighter text-on-surface"
          >
            TECHNICAL <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary-container to-secondary">ARCHITECT</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="max-w-2xl mx-auto font-sans text-on-surface-variant text-lg md:text-xl leading-relaxed"
          >
            Designing <span className="text-primary font-bold">scalable</span>, <span className="text-secondary font-bold">modular</span>, and <span className="text-primary-container font-bold">cloud-native</span> systems for high-performance engineering environments.
          </motion.p>
          ...
          >
            <button className="px-8 py-4 bg-gradient-to-r from-primary to-primary-container text-on-primary font-headline font-bold rounded-lg shadow-lg hover:shadow-primary/20 transition-all hover:scale-105 active:scale-95 flex items-center gap-3">
              <Terminal size={20} />
              INITIALIZE_CORE
            </button>
            <button className="px-8 py-4 bg-surface-variant/20 backdrop-blur-md border border-outline-variant/30 text-primary font-headline font-bold rounded-lg hover:bg-surface-variant/40 transition-all flex items-center gap-3">
              <Workflow size={20} />
              VIEW_NODES
            </button>
          </motion.div>
